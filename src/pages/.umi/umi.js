...
import findRoute, {
  getUrlQuery,
} from '/Users/awang/Downloads/antd pro/create/node_modules/_umi-build-dev@1.13.13@umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    // Umi UI Bubble
    require('../../../node_modules/_umi-plugin-ui@1.2.13@umi-plugin-ui/lib/bubble').default(
      {
        port: 3000,
        path: '/Users/awang/Downloads/antd pro/create',
        currentProject: '',
        isBigfish: undefined,
      },
    );
...
(() => {
  ...
  window.GUmiUIFlag = require('../../../node_modules/_umi-build-dev@1.13.13@umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
